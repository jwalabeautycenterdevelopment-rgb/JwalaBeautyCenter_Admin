                ...
                >
                    ...
                    <div className="p-4">
                        ...
                        <div className="text-sm text-gray-600 space-y-1">
                            ...
                            <p className={`font-medium ${(product?.stock > 0) || (product?.variants?.[0]?.stock > 0) ? "text-green-600" : "text-red-600"
                                }`}>
                    ...
                    <div className="text-center py-12 bg-white rounded-lg shadow">
                        ...
                        {!search && (
                            <div className="flex items-center justify-center">
                                <button
                                    onClick={handleAdd}
                                    className="flex items-center text-sm bg-linear-to-r from-pink-300 to-purple-600 hover:from-pink-700 hover:to-purple-700 text-white font-medium cursor-pointer py-3 px-6  transform hover:-translate-y-0.5 transition-all duration-200 disabled:opacity-50 disabled:transform-none disabled:hover:shadow-lg"
                                >
                                    <FaPlus size={14} />
                                    Add Product
                                </button>
